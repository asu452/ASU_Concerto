...
//Database Connection
$db_host = 'localhost';
$db_login = 'testconcerto';
$db_password = 'cs452test';
$db_database = 'concertotest';

//Important paths

define('ROOT_DIR', '/var/www/concertotest/concerto/');                    //server-side path where Concerto lives
...
define('ROOT_URL', '/concertotest/concerto/');                         //the root location where Concerto lives
